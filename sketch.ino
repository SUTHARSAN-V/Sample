#define BLYNK_AUTH_TOKEN "SE4lyMok56KzlHZiaDK4k7yNWiEU7ZyO"
#define BLYNK_TEMPLATE_ID "TMPL3_RxQnUZ2"
#define BLYNK_TEMPLATE_NAME "Smart Soil Monitoring Final"
...
void displayTeamMembers() 
{
  ...
  display.println("");
  display.println("Sutharsan V");
  display.println("Murugan G");
  display.println("Shabareeson R");
  display.println("Naresh K");
  display.display();
}
...
void displaydetails()
{
  ...
  display.setTextColor(SSD1306_WHITE);
  display.setCursor(0, 10);
  display.println("Empowering Farmers");
  display.println("");
  display.println("With Smart Tech");
  display.display();
}
...
void sendData() {
  ...
  Serial.print("Moisture: " + String(potValue));
  Serial.print("\t");
